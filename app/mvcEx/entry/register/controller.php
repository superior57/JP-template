<?php
	...
	*/
	class AppentryRegisterController extends AppBaseController //
	{
		//■処理 //
		...
		*/
		function __construct() //
		{
			...
			Concept::isTrue(SystemUtil::getTableData("nUser",$LOGIN_ID,"edit_comp"))->OrThrow("userDataUnedited");
			Concept::isTrue(resumeLogic::existsResume($LOGIN_ID))->OrThrow("NotExistsResume");
