<?php
	...
	*/
	class AppReInstallView extends AppBaseView //
	{
		//■処理 //
		...
		*/
		function drawInstallFormPage( $iModel ) //
			{ include $this->templatePath . 'reinstall/db/install.html'; }
		...
		*/
		function drawConfirmInstallPage( $iModel ) //
			{ include $this->templatePath . 'reinstall/db/installCheck.html'; }
		...
		*/
		function drawSucceededInstallPage( $iModel ) //
			{ include $this->templatePath . 'reinstall/db/installComp.html'; }
