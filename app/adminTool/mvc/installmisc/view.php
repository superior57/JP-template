<?php
	...
	/**
		@brief 既定の管理ツールのその他の設定処理のビュー。
	*/
	class AppInstallMiscView extends AppBaseView //
	{
		//■処理 //
		...
		*/
		function drawInstallFormPage( $iModel ) //
			{ include $this->templatePath . 'install/misc/install.html'; }
		...
		*/
		function drawConfirmInstallPage( $iModel ) //
			{ include $this->templatePath . 'install/misc/installCheck.html'; }
		...
		*/
		function drawSucceededInstallPage( $iModel ) //
			{ include $this->templatePath . 'install/misc/installComp.html'; }
