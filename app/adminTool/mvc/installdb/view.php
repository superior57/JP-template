<?php
	...
	*/
	class AppInstallDBView extends AppBaseView //
	{
		//■処理 //
		...
		*/
		function drawInstallFormPage( $iModel ) //
			{ include $this->templatePath . 'install/db/install.html'; }
		...
		*/
		function drawConfirmInstallPage( $iModel ) //
			{ include $this->templatePath . 'install/db/installCheck.html'; }
		...
		*/
		function drawSucceededInstallPage( $iModel ) //
			{ include $this->templatePath . 'install/db/installComp.html'; }
