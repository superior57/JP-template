<?php
	...
	*/
	class AppInstallTableView extends AppBaseView //
	{
		//■処理 //
		...
		*/
		function drawInstallFormPage( $iModel ) //
			{ include $this->templatePath . 'install/table/install.html'; }
		...
		*/
		function drawSucceededInstallPage( $iModel ) //
			{ include $this->templatePath . 'install/table/installComp.html'; }
