...
$(function()
{
	...
	checkVal();
	outputResult();
	$("#inputPassword").on("keyup", checkVal);
...
function outputResult()
{
	...
	{ 
		complexity.html("強度インジケータ").removeClass("weak strong stronger strongest").addClass("default");
	}
	else if (charPassword.length < minPasswordLength && charPassword!=undefined)
	{
		complexity.html("※半角英数字" + minPasswordLength+ "文字以上").removeClass("strong stronger strongest").addClass("weak");
	}
	else if (score<50)
	{
		complexity.html("非常に弱い").removeClass("strong stronger strongest").addClass("weak");
	}
	else if (score>=50 && score<75)
	{
		complexity.html("弱い").removeClass("stronger strongest").addClass("strong");
	}
	else if (score>=75 && score<100)
	{
		complexity.html("普通").removeClass("strongest").addClass("stronger");
	}
	else if (score>=100)
	{
		complexity.html("強力").addClass("strongest");
	}
